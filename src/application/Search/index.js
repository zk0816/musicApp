...
import SearchBox from './../../baseUI/SearchBox/index';
import { getHotKeyWords, changeEnterLoading, getSuggestList } from './store/actionCreators';
import { connect } from 'react-redux';
import { getSongDetail,changePlayList,changeCurrentIndex ,changeSequecePlayList} from './../Player/store/actionCreators';
...
import MusicalNote from '../../baseUI/MusicNnote';
...
function Search(props) {
  ...
  const suggestList = immutableSuggestList;
  const songsList = immutableSongsList || [];
  ...
  const selectItem = (e, id) => {
    ...
    changePlayListDispatch(e);
    changeSequecePlayListDispatch(e);
    changeCurrentIndexDispatch (id);
    console.log(e);
